...
const About = () => {
 ...
 <h1 className='ml-50 mt-50'>Assign tasks and manage deadlines</h1>
      <div className='max-w-7xl mx-auto flex justify-between items-center mb-20'>
       
        <p className='ml-50 font-semibold'>DS’s advanced checklists give you the power to add more context to your tasks by assigning team members and due dates to checklist items, increasing visibility and keeping your team accountable.</p>
